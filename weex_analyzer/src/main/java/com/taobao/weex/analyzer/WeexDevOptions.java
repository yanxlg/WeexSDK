...
public class WeexDevOptions implements IWXDevOptions {
    ...
    private List<DevOption> registerDefaultOptions() {
        ...
        options.add(new DevOption("weex性能指标", R.drawable.wxt_icon_performance, new DevOption.OnOptionClickListener() {
            ...
            public void onOptionClick() {
                if (mCurPageName == null) {
                    Toast.makeText(topActivity, "internal error", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                WXPerformanceAnalysisView view = new WXPerformanceAnalysisView(topActivity, performance, list,mConfig);
                view.show();
            }
        ...
        options.add(new DevOption("weex storage", R.drawable.wxt_icon_storage, new DevOption.OnOptionClickListener() {
            @Override
            public void onOptionClick() {
                StorageView mStorageView = new StorageView(topActivity,mConfig);
                mStorageView.show();
            }
        ...
        options.add(new DevOption("fps", R.drawable.wxt_icon_fps, new DevOption.OnOptionClickListener() {
            ...
            public void onOptionClick() {
                if (!FPSSampler.isSupported()) {
                    Toast.makeText(topActivity, "your device is not support.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        options.add(new DevOption("js远程调试", R.drawable.wxt_icon_debug, new DevOption.OnOptionClickListener() {
            @Override
            public void onOptionClick() {
                RemoteDebugManager.getInstance().toggle(topActivity);
            }
        }));
        ...
        options.add(new DevOption("配置", R.drawable.wxt_icon_settings, new DevOption.OnOptionClickListener() {
            @Override
            public void onOptionClick() {
                SettingsActivity.launch(topActivity);
            }
        }));
        return options;
    }
    ...
    /**
     * 显示调试窗口
     * 兼容预加载处理 Context设置为ApplicationContext
     */
    public void showDevOptions() {
        if (shown || topActivity == null) {
            return;
        }
        ...
        EntranceView.Creator creator = new EntranceView.Creator(topActivity)
